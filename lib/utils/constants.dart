...
const String baseUrl =
    "http://admin.nilesons.net"; //https://testschool.wrteam.in
const String databaseUrl = "$baseUrl/api/";
final String schoolName ="NileSons";
...
const Duration homeMenuBottomSheetAnimationDuration = Duration(milliseconds: 300);
